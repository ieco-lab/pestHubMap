...
Here, hub datasets will be reduced to four columns: Name, Address, Latitude and Longitude. The template is built to only accomodate hub data with those exact columns.
